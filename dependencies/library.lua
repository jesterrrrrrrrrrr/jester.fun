...
function UI.Text(props, children)
	...
	local defaults = {
		BackgroundTransparency = 1,
		Font =  Font.fromId(12187365364, Enum.FontWeight.Medium, Enum.FontStyle.Normal)to,
...
function Components.Paragraph(parent, title, content, theme, layoutOrder)
	local textHeight = Util.GetTextSize(content, 13, Font.fromEnum( Font.fromId(12187365364, Enum.FontWeight.Medium, Enum.FontStyle.Normal)to), Vector2.new(300, math.huge))
	...
	function paragraphObj:SetText(newContent)
		if newContent then
			...
			local newHeight =
				Util.GetTextSize(newContent, 13, Font.fromEnum( Font.fromId(12187365364, Enum.FontWeight.Medium, Enum.FontStyle.Normal)to), Vector2.new(300, math.huge))
...
function Xan:CreateWindow(config)
	...
	local function createSearchResultItem(elementData, index)
		...
		local typeBadgeText = Util.Create("TextLabel", {
			...
			BackgroundTransparency = 1,
			Size = UDim2.new(1, 0, 1, 0),
			Font = isButtonType and  Font.fromId(12187365364, Enum.FontWeight.Medium, Enum.FontStyle.Normal)to or  Font.fromId(12187365364, Enum.FontWeight.Medium, Enum.FontStyle.Normal)to,
	...
	function window:CreateTab(tabConfig)
		...
		function tab:CreateDropdown(config)
			...
			local optionsList = Util.Create("Frame", {
				...
				Size = UDim2.new(1, -16, 0, #options * optionHeight + math.max(0, #options - 1) * spacing),
				ClipsDescendants = false,
				Parent = dropdownFrame,
			}, {
				Util.Create("UIListLayout", {
		...
		function tab:CreateKeybind(config)
			...
			local keyBtn = Util.Create("TextButton", {
				...
				Font =  Font.fromId(12187365364, Enum.FontWeight.Medium, Enum.FontStyle.Normal),
